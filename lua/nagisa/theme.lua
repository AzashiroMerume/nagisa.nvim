local function setup(c, opts)
    local highlights = {
        ...
        ['DiffAdd'] = {fg = 'NONE', bg = c.greenLight},
        ['DiffChange'] = {fg = 'NONE', bg = c.redDark},
        ['DiffDelete'] = {fg = 'NONE', bg = c.redLight},
        ['DiffText'] = {fg = 'NONE', bg = c.redLight},
        ...
        ['PmenuSel'] = {fg = c.grayLight, bg = c.blueDark},
        ...
        ['Visual'] = {fg = c.nsaNone, bg = c.blueDarker},
        ['VisualNOS'] = {fg = c.nsaNone, bg = c.blueDarker},
        ['WarningMsg'] = {fg = c.nsaOrange, bg = c.nsaBack, bold = true},
        ['WildMenu'] = {fg = c.nsaNone, bg = c.blueDarker},
        ['Comment'] = {
            fg = c.nsaGray,
            bg = 'NONE',
        ...
        ['Identifier'] = {fg = c.nsaPink, bg = 'NONE'},
